...
/**
 * @typedef {Object} OCAL
 * @property {string} message_unsaved_changes
...
(function () {
    ...
    function warning(event) {
        let confirmation = OCAL.message_unsaved_changes;
        // @ts-ignore
    ...
    function makeEditor(element) {
        ...
        function onSelectState(event) {
            ...
            element.querySelectorAll(".ocal_toolbar").forEach(function (element) {
            ...
            element.querySelectorAll(".ocal_calendar td.ocal_state").forEach(function (cell) {
        ...
        function onSave() {
            ...
            let tokenInput = element.querySelector("input[name=xh_csrf_token]");
            if (tokenInput instanceof HTMLInputElement) {
                payload += "&xh_csrf_token=" + tokenInput.value;
            }
        ...
        element.querySelectorAll(".ocal_save").forEach(function (button) {
    ...
    init = function (event) {
        ...
        if (OCAL.isAdmin) {
            document.querySelectorAll(".ocal_calendars, .ocal_week_calendars").forEach(makeEditor);
        }
    };
